...
|------|-------------|------|---------|:--------:|
| <a name="input_alb_backend_groups_labels"></a> [alb\_backend\_groups\_labels](#input\_alb\_backend\_groups\_labels) | Default backend group labels | `map(string)` | <pre>{<br>  "created_by": "terraform yc module"<br>}</pre> | no |
